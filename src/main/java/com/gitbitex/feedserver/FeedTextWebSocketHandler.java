...
import com.gitbitex.feedserver.message.Request;
import com.gitbitex.feedserver.message.SubscribeRequest;
import com.gitbitex.feedserver.message.UnsubscribeRequest;
    ...
    public void handleTextMessage(WebSocketSession session, TextMessage message) {
        ...
        switch (request.getType()) {
            ...
            case "unsubscribe": {
                ...
                sessionManager.subOrUnSub(session, unsubscribeRequest.getProductIds(), unsubscribeRequest.getCurrencyIds(),
