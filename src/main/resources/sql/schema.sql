...
CREATE TABLE IF NOT EXISTS `account` (
                           ...
                           `available` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                           `hold` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                           PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `bill` (
                        ...
                        `user_id` varchar(255) NOT NULL DEFAULT '',
                        `currency` varchar(255) NOT NULL DEFAULT '',
                        `available_increment` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                        `hold_increment` decimal(19,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `candle` (
                          ...
                          `open` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                          `close` decimal(19,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `fill` (
                        ...
                        `size` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                        `price` decimal(19,8) DEFAULT NULL,
                        `funds` decimal(19,8) NOT NULL DEFAULT '0.00000000',
...
CREATE TABLE IF NOT EXISTS `order` (
                         ...
                         `type` varchar(255) DEFAULT NULL,
                         `size` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                         `filled_size` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                         `price` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                         `funds` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                         `executed_value` decimal(19,8) NOT NULL DEFAULT '0.00000000',
                         `fill_fees` decimal(19,8) NOT NULL DEFAULT '0.00000000',
